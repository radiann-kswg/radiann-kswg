...
- **言語**: Python / TypeScript / C# / C++ / HTML・CSS(SASS) / JavaScript(Vue.js 3)
- **開発スタイル**: VSCode ＋ Claude / GitHub Copilot によるAI協働開発（バイブコーディング）
- **その他**: GitHub Pages / Cloudflare Workers / Service Worker / VRM・Unity(VRChat)
